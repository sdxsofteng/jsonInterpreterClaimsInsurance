...
public enum Message {
    ...
    INVALID_INPUT_FILE(-4, "Fichier d'entree invalide"),
    ...
    MISSING_FILENUMBER( -10, "Numéro de dossier manquant"),
    INCORRECT_FILENUMBER( -11, "Numéro de dossier invalide"),

    MISSING_INVOICE_DATE( -12, "Mois de reclamation manquant"),
    INCORRECT_INVOICE_DATE( -13, "Mois de reclamation invalide"),
    ...
    INVALID_TREATMENT_COST_TOO_LOW( -26, "Le cout d'un soin ne peut pas etre egal ou inferieur a 0"),
    MONTHLY_TREATMENT_COST_TOO_HIGH( -27, "Le montant mensuel total pour ce type de soin dépasse le maximum de 500$"),

    CLAIM_DATE_LIMIT_REACHED( -30, "Maximum de soins par jour depasse"),
